...
<cfelseif action eq "showDirectoryListing">
	...
	<cfif not cffm.readOnly>
		...
		<td align="center" width="40"><a href="javascript:void(0);" onclick="showCreateFileForm();"><img class="cffmIcon" src="#cffm.iconPath#/newfile.png" width="32" height="32" alt="#cffm.resourcekit['buttonText.t7']#" title="#cffm.resourcekit['buttonText.t7']#">#cffm.resourcekit['buttonText.t7']#</a></div></td>
