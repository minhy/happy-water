...
<cfparam name="FORM.priority" type="integer" default="0">
	...
	<cfif NOT  Validation.isInvalid>
		...
		<cfquery name="qUpdateMenu">
			update menu set 
				...
				menu_TF=<cfqueryparam sqltype="integer" value="#FORM.active#"/>
					...
					<table>
						...
						<tr>
							...
							<td class="form#Validation.menu_priority.class#" >
								<input type="text" name="priority" value="#FORM.priority#" size="50"/>
						...
						<tr>
							...
							<td class="form#Validation.menu_parentid.class#" >
								<input type="text" name="parentid" value="#FORM.parentid#" size="50"/>
